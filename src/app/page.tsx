    ...
    <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex flex-col gap-0.5">
            ...
            <p className="text-xs text-[#71717a] tracking-wide">
              DOCK50–DOCK72 &nbsp;|&nbsp; September 19, 2026 &nbsp;|&nbsp; Last refreshed: Sep 19 15:02 PT
            </p>
          </div>
          {/* Facility badge */}
        ...
        <section>
          <div className="bg-[#141419] border border-[#1e1e2a] rounded-xl p-5 flex flex-col gap-2">
            ...
            <ul className="text-xs text-[#71717a] space-y-1 list-disc list-inside">
              ...
              <li><strong className="text-[#22c55e]">★ Scheduled inbounds:</strong> 0 of 3 received for the September 19 local day (0.0%). Cohort: 3 receipts with appointmentTime on Sep 19 (3 IMPORTED; 2 GURUNANDA, LLC + 1 EMBER TECHNOLOGIES, INC.); received = CLOSED.</li>
              <li><strong className="text-[#f59e0b]">⚠ Aged Anomalies:</strong> DOCK50 has been held 333d 1h 40m by an ended-but-unclosed RECEIVE task (TASK-5090739, endTime 2025-10-22). DOCK54 has been held 42d 22h 32m by an ended-but-unclosed LOAD task (TASK-5338695, endTime 2026-08-10); DOCK54 TASK-5365421 also ended 2026-09-11 without closing.</li>
              ...
              <li>All core metrics sourced from live WISE/WMS queries, September 19, 2026 15:02 PT. Per-task assignee mapping resolved via load-task and receive-task APIs.</li>
            </ul>
          </div>
        </section>
      </main>
      ...
      <footer className="border-t border-[#1e1e2a] bg-[#0a0a0f] mt-2">
        <div className="max-w-[1440px] mx-auto px-6 py-4 flex items-center justify-between text-xs text-[#71717a]">
          ...
          <span>Last refreshed: September 19, 2026 15:02 PT</span>
        </div>
      </footer>
    </div>
  );
