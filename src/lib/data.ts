 ...
 *
 * TASK DATA: Refreshed 2026-09-18 13:23 PDT (live WISE/WMS APIs, read-only)
 *   Sources:
...
// Duration = as-of 2026-09-18 13:23 PDT minus the earliest open IN_PROGRESS task startTime on the door.
...
export const doors: DoorRecord[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  { door: "DOCK50", status: "Occupied", assignee: "daira gonzalez", customer: "GURUNANDA, LLC", taskIds: ["TASK-5090739"], duration: "332d 00h 02m", anomaly: true },
  { door: "DOCK54", status: "Occupied", assignee: "ARNULFO MUNGUIA / CANDY MENDEZ", customer: "GURUNANDA, LLC / KARAKA, LLC", taskIds: ["TASK-5338695","TASK-5365421","TASK-5364490","TASK-5369031"], duration: "41d 20h 54m", anomaly: true },
  { door: "DOCK55", status: "Occupied", assignee: "RUFINO MUNGUIA / DANIELA GONZALEZ / JEROME ARANDA", customer: "GURUNANDA, LLC / KARAKA, LLC", taskIds: ["TASK-5371830","TASK-5369975","TASK-5368665"], duration: "0d 21h 41m", anomaly: false },
  { door: "DOCK57", status: "Occupied", assignee: "DANIELA GONZALEZ", customer: "GURUNANDA, LLC", taskIds: ["TASK-5371291"], duration: "0d 17h 12m", anomaly: false },
  { door: "DOCK62", status: "Occupied", assignee: "ARNULFO MUNGUIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5365814"], duration: "3d 22h 38m", anomaly: false },
  { door: "DOCK66", status: "Occupied", assignee: "RUFINO MUNGUIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5371832"], duration: "0d 02h 33m", anomaly: false },
  ...
  { door: "DOCK60", status: "Reserved", assignee: "RUFINO MUNGUIA", customer: "GURUNANDA, LLC", taskIds: ["TASK-5371932","TASK-5371839"], duration: null, anomaly: false },
...
export const assigneeSummaries: AssigneeSummary[] = [
  ...
  { name: "RUFINO MUNGUIA", taskCount: 4 },
...
// Mix: 2 LOAD (outbound) + 12 RECEIVE (inbound) = 14 active tasks at Bay 4 doors
export const inboundOutboundMix: MixMetric[] = [
  { label: "Outbound", count: 2, total: 14 },
  { label: "Inbound", count: 12, total: 14 },
];
...
export const pctScheduledInboundReceived = (1 / 29) * 100;
export const pctScheduledOutboundLoaded = (42 / 119) * 100;
...
// Active task records from fresh WISE data (September 18, 2026 13:23 PDT)
// 14 active tasks: 2 LOAD (outbound) + 12 RECEIVE (inbound)
export const assignments: TaskRecord[] = [
  { taskId: "TASK-5090739", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (332d 00h 02m) ⚠ STALE", assignee: "daira gonzalez", door: "DOCK50" },
  { taskId: "TASK-5338695", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (41d 20h 54m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5365421", dns: "LOAD IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (7d 03h 51m) ⚠ STALE", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5364490", dns: "RECEIVE IN_PROGRESS", customer: "KARAKA, LLC", pieces: "IN_PROGRESS (2d 21h 00m)", assignee: "ARNULFO MUNGUIA", door: "DOCK54" },
  { taskId: "TASK-5369031", dns: "RECEIVE NEW", customer: "GURUNANDA, LLC", pieces: "NEW — not started", assignee: "CANDY MENDEZ", door: "DOCK54" },
  { taskId: "TASK-5369975", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (0d 21h 41m)", assignee: "DANIELA GONZALEZ", door: "DOCK55" },
  ...
  { taskId: "TASK-5371291", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (0d 17h 12m)", assignee: "DANIELA GONZALEZ", door: "DOCK57" },
  ...
  { taskId: "TASK-5365814", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (3d 22h 38m)", assignee: "ARNULFO MUNGUIA", door: "DOCK62" },
  { taskId: "TASK-5371832", dns: "RECEIVE IN_PROGRESS", customer: "GURUNANDA, LLC", pieces: "IN_PROGRESS (0d 02h 33m)", assignee: "RUFINO MUNGUIA", door: "DOCK66" },
];
